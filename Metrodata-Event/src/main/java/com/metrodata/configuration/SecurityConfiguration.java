    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests((authorizeHttpRequests) -> authorizeHttpRequests
                        ...
                        .requestMatchers("/session-detail/**").authenticated()
                        .requestMatchers("/participant/**").authenticated()
                        .requestMatchers("/sponsor/**").authenticated()
                        .requestMatchers("/speaker/**").authenticated()
                        .requestMatchers("/room/**").authenticated()
                        .requestMatchers("/certificate/**").authenticated()
                        .requestMatchers("/email/**").authenticated()
                        .requestMatchers("/email-html/**").authenticated()
                        .requestMatchers("/email-attach/**").authenticated()
                )
